...
const Hero = () => (
  <section className="py-16 flex flex-col w-ful; lg:flex-row  gap-20 lg:gap-28" >
    ...
    <div className="text-center max-w-[32rem] lg:max-w-[36rem] lg:text-left  lg:w-[50%] self-center lg:self-start lg:mt-16">
      ...
      <button className="px-6 mt-7 py-3 font-medium text-xl bg-gradient text-white rounded-xl hover:scale-[104%] transition-all duration-100 ease-out focus:scale-[104%] ">Get started</button>
    </div>
  </section>
)
