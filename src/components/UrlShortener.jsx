...
const ShortenUrlList = () => {
  return (
    <div className='hidden mt-8 md:mt-11  flex flex-col gap-4'>
    ...
    <section className='py-20 '>
      <form action="#" className='mx-auto  bg-textColor p-6 md:p-8 max-w-[62rem] rounded-2xl'>
        <div className="flex flex-col gap-4 md:flex-row md:gap-3  md:justify-between">
          ...
          <button className='bg-accent text-white font-semibold text-xl px-6 py-4 rounded-xl hover:bg-[#b3125a]'>Shorten</button>
        </div>
        <ShortenUrlList/>
      </form>
    </section>
